...
import { cohere_quiz_easy , cohere_quiz_medium, cohere_quiz_hard } from './constants';
...
class QuizMe extends React.Component {
  ...
  render() {
    ...
    <div>
      <button onClick={() => this.onCohereCall(cohere_quiz_easy)}>
        Quiz - Category easy
      </button>
      <button onClick={() => this.onCohereCall(cohere_quiz_medium)}>
        Quiz - Category medium
      </button>
      <button onClick={() => this.onCohereCall(cohere_quiz_hard)}>
        Quiz - Category hard
      </button>
    </div>
